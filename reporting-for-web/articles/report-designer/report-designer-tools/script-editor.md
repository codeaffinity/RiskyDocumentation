...
Intelligent code completion is available only for .NET Framework and Risky libraries deployed with the application and cannot be provided for custom assemblies.
